...
function updateQuoteEl(quoteObj) {
  var content = quoteObj.content,
      author = quoteObj.author;
  var fullString = "".concat(content, " - ").concat(author);
...
function _handleClick() {
  _handleClick = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
    var quoteObj;
